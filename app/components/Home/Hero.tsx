    ...
    <>
        ...
        <div className="flex justify-evenly items-center">
          <div className="">
            ...
            <div className="flex space-x-4">
              <button className="bg-black-700 text-white p-3 border border-black-700 rounded-md">
                Get Started
              </button>
              <button className="text-black-700 border border-black-700 p-3 rounded-md">
                Learn More
              </button>
            </div>
      ...
      <div className="w-full flex justify-center">
        <button className="flex flex-col items-center">
          <span className="text-black-400">see more</span>
          <svg
            className="w-4 h-4 animate-bounce duration-1000 fill-black-700"
            xmlns="http://www.w3.org/2000/svg"
            height="16"
            width="14"
            viewBox="0 0 448 512"
