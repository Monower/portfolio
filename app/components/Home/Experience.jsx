  ...
  return (
    <>
      <section className="container mx-auto px-[2vw] lg:px-[3vw] flex justify-between  min-h-[100vh]">
        <h3 className="text-black-900 text-24 font-bold text-center w-[30%]">Experience</h3>
        <div className="w-[70%] h-[80vh] overflow-auto no-scrollbar">
          <Link
            href="https://www.google.com/"
            target="_blank"
            className="group flex space-x-4 p-4 rounded cursor-pointer hover:bg-gray-300 transition-all duration-700"
          >
            <header className="text-black-900 text-[14px]">
              2023 - present
            </header>
            <div>
              <h3>
                <div>
                  ...
                  <p>
                    ...
                    labore, placeat magnam obcaecati nesciunt? Deleniti,
                    repellendus dolorem a perspiciatis tenetur numquam non!
                  </p>
